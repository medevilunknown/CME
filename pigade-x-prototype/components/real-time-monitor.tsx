 ...
 * Currently mocks connection status & latency for demo purposes.
 */
export default function RealTimeMonitor() {
  ...
  useEffect(() => {
    // Simulate handshake & latency measurement
    const timer = setTimeout(() => {
      setStatus("active")
      setLatency(1.8) // seconds; replace with real ping when backend is wired
    }, 1500)
